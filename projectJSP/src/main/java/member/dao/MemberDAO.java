...
public class MemberDAO {
    ...
    //이메일의 첫 번째 부분을 가져오는 메서드
    public String getEmailPart1(String id) {
        String email1 = null;
        String sql = "select email1 from member where id=?";
    ...
    //이메일의 두 번째 부분을 가져오는 메서드
    public String getEmailPart2(String id) {
        String email2 = null;
        String sql = "select email2 from member where id=?";
    ...
    public void update(MemberDTO memberDTO) {
        ...
        try {
            ...
            pstmt.setString(12, memberDTO.getId());  //where 절에 id 설정
